    ...
    >
      <v-list subheader>
        <v-list-tile>
          ...
          <v-list-tile-content>
            <router-link :to="'/'">
              <v-list-tile-title>Тест</v-list-tile-title>
            </router-link>
          </v-list-tile-content>
        </v-list-tile>
        <v-divider>
        ...
        <v-list-tile>
          ...
          <v-list-tile-content>
            <router-link :to="'/medos/ter'">
              <v-list-tile-title>Рабочее место терапевта</v-list-tile-title>
            </router-link>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile>
          ...
          <v-list-tile-content>
            <router-link :to="'/medos/companies'">
        ...
        <v-list-tile>
          ...
          <v-list-tile-content>
            <router-link :to="'/medos/harms'">
              <v-list-tile-title>Редактор вредностей</v-list-tile-title>
            </router-link>
          </v-list-tile-content>
        </v-list-tile>
        <v-divider>
